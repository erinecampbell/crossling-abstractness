...
chinese_beijing_CD_model <- glm(produces ~ age + chinese_CD_rating + chinese_freq_rating + lexical_category, data = mandarin_beijing_instrument_data, family = "binomial")
...
chinese_beijing_CD_summary <- summary(chinese_beijing_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "chinese_beijing",
         ...
         p_value = `Pr(>|z|)`)
chinese_beijing_CD_interaction_model <- glm(produces ~ age * chinese_CD_rating + chinese_freq_rating + lexical_category, data = mandarin_beijing_instrument_data, family = "binomial")
...
chinese_cantonese_CD_model <- glm(produces ~ age + chinese_CD_rating + chinese_freq_rating + lexical_category, data = cantonese_instrument_data, family = "binomial")
...
chinese_taiwanese_CD_model <- glm(produces ~ age + chinese_CD_rating + chinese_freq_rating + lexical_category, data = mandarin_taiwanese_instrument_data, family = "binomial")
...
chinese_taiwanese_CD_summary <- summary(chinese_taiwanese_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "chinese_taiwanese",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
chinese_taiwanese_CD_interaction_model <- glm(produces ~ age * chinese_CD_rating + chinese_freq_rating + lexical_category, data = mandarin_taiwanese_instrument_data, family = "binomial")
...
czech_CD_model <- glm(as.factor(produces) ~ age + czech_CD_rating + czech_freq_rating + lexical_category + word_length, data = czech_instrument_data, family = "binomial")
...
czech_CD_summary <- summary(czech_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "czech",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
czech_CD_interaction_model <- glm(as.factor(produces) ~ age * czech_CD_rating + czech_freq_rating + lexical_category + word_length, data = czech_instrument_data, family = "binomial")
...
danish_CD_model <- glm(as.factor(produces) ~ age + danish_CD_rating + danish_freq_rating + lexical_category + word_length, data = danish_instrument_data, family = "binomial")
...
danish_CD_summary <- summary(danish_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "danish",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
danish_CD_interaction_model <- glm(as.factor(produces) ~ age * danish_CD_rating + danish_freq_rating + lexical_category + word_length, data = danish_instrument_data, family = "binomial")
...
dutch_CD_model <- glm(as.factor(produces) ~ age + dutch_CD_rating + dutch_freq_rating + lexical_category + word_length, data = dutch_instrument_data, family = "binomial")
...
dutch_CD_summary <- summary(dutch_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "dutch",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
dutch_CD_interaction_model <- glm(as.factor(produces) ~ age * dutch_CD_rating + dutch_freq_rating + lexical_category + word_length, data = dutch_instrument_data, family = "binomial")
...
english_american_CD_model <- glm(produces ~ age + english_CD_rating + english_freq_rating + lexical_category + word_length, data = american_english_instrument_data, family = "binomial")
...
english_american_CD_summary <- summary(english_american_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "english_american",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
english_american_CD_interaction_model <- glm(produces ~ age * english_CD_rating + english_freq_rating + lexical_category + word_length, data = american_english_instrument_data, family = "binomial")
...
english_australian_CD_model <- glm(produces ~ age + english_CD_rating + english_freq_rating + lexical_category + word_length, data = australian_english_instrument_data, family = "binomial")
...
english_australian_CD_summary <- summary(english_australian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "english_australian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
english_australian_CD_interaction_model <- glm(produces ~ age * english_CD_rating + english_freq_rating + lexical_category + word_length, data = australian_english_instrument_data, family = "binomial")
...
english_british_CD_model <- glm(produces ~ age + english_CD_rating + english_freq_rating + lexical_category + word_length, data = british_english_instrument_data, family = "binomial")
...
english_british_CD_summary <- summary(english_british_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "english_british",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
english_british_CD_interaction_model <- glm(produces ~ age * english_CD_rating + english_freq_rating + lexical_category + word_length, data = british_english_instrument_data, family = "binomial")
...
english_irish_CD_model <- glm(produces ~ age + english_CD_rating + english_freq_rating + lexical_category + word_length, data = irish_english_instrument_data, family = "binomial")
...
english_irish_CD_summary <- summary(english_irish_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "english_irish",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
english_irish_CD_interaction_model <- glm(produces ~ age * english_CD_rating + english_freq_rating + lexical_category + word_length, data = irish_english_instrument_data, family = "binomial")
...
finnish_CD_model <- glm(as.factor(produces) ~ age + finnish_CD_rating + finnish_freq_rating + lexical_category + word_length, data = finnish_instrument_data, family = "binomial")
...
finnish_CD_summary <- summary(finnish_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "finnish",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
finnish_CD_interaction_model <- glm(as.factor(produces) ~ age * finnish_CD_rating + finnish_freq_rating + lexical_category + word_length, data = finnish_instrument_data, family = "binomial")
...
french_european_CD_model <- glm(as.factor(produces) ~ age + french_CD_rating + french_freq_rating + lexical_category + word_length, data = french_european_instrument_data, family = "binomial")
...
french_european_CD_summary <- summary(french_european_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "french_european",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
french_european_CD_interaction_model <- glm(as.factor(produces) ~ age * french_CD_rating + french_freq_rating + lexical_category + word_length, data = french_european_instrument_data, family = "binomial")
...
french_quebecois_CD_model <- glm(as.factor(produces) ~ age + french_CD_rating + french_freq_rating + lexical_category + word_length, data = french_quebecois_instrument_data, family = "binomial")
...
french_quebecois_CD_summary <- summary(french_quebecois_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "french_quebecois",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
french_quebecois_CD_interaction_model <- glm(as.factor(produces) ~ age * french_CD_rating + french_freq_rating + lexical_category + word_length, data = french_quebecois_instrument_data, family = "binomial")
...
german_CD_model <- glm(as.factor(produces) ~ age + german_CD_rating + german_freq_rating + lexical_category + word_length, data = as.data.frame(german_instrument_data), family = "binomial")
...
german_CD_summary <- summary(german_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "german",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
german_CD_interaction_model <- glm(as.factor(produces) ~ age * german_CD_rating + german_freq_rating + lexical_category + word_length, data = as.data.frame(german_instrument_data), family = "binomial")
...
greek_CD_model <- glm(as.factor(produces) ~ age + greek_CD_rating + greek_freq_rating + lexical_category + word_length, data = as.data.frame(greek_instrument_data), family = "binomial")
...
greek_CD_summary <- summary(greek_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "greek",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
greek_CD_interaction_model <- glm(as.factor(produces) ~ age * greek_CD_rating + greek_freq_rating + lexical_category + word_length, data = as.data.frame(greek_instrument_data), family = "binomial")
...
hebrew_CD_model <- glm(as.factor(produces) ~ age + hebrew_CD_rating + hebrew_freq_rating + lexical_category + word_length, data = as.data.frame(hebrew_instrument_data), family = "binomial")
...
hebrew_CD_summary <- summary(hebrew_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "hebrew",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
hebrew_CD_interaction_model <- glm(as.factor(produces) ~ age * hebrew_CD_rating + hebrew_freq_rating + lexical_category + word_length, data = as.data.frame(hebrew_instrument_data), family = "binomial")
...
hungarian_CD_model <- glm(as.factor(produces) ~ age + hungarian_CD_rating + hungarian_freq_rating + lexical_category + word_length, data = as.data.frame(hungarian_instrument_data), family = "binomial")
...
hungarian_CD_summary <- summary(hungarian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "hungarian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
hungarian_CD_interaction_model <- glm(as.factor(produces) ~ age * hungarian_CD_rating + hungarian_freq_rating + lexical_category + word_length, data = as.data.frame(hungarian_instrument_data), family = "binomial")
...
irish_CD_model <- glm(as.factor(produces) ~ age + irish_CD_rating + irish_freq_rating + lexical_category + word_length, data = as.data.frame(irish_instrument_data), family = "binomial")
...
irish_CD_summary <- summary(irish_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "irish",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
irish_CD_interaction_model <- glm(as.factor(produces) ~ age * irish_CD_rating + irish_freq_rating + lexical_category + word_length, data = as.data.frame(irish_instrument_data), family = "binomial")
...
italian_CD_model <- glm(produces ~ age + italian_CD_rating + italian_freq_rating + lexical_category + word_length, data = italian_instrument_data, family = "binomial")
...
italian_CD_summary <- summary(italian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "italian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
italian_CD_interaction_model <- glm(produces ~ age * italian_CD_rating + italian_freq_rating + lexical_category + word_length, data = italian_instrument_data, family = "binomial")
...
kiswahili_CD_model <- glm(produces ~ age + kiswahili_CD_rating + kiswahili_freq_rating + lexical_category + word_length, data = kiswahili_instrument_data, family = "binomial")
...
kiswahili_CD_summary <- summary(kiswahili_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "kiswahili",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
kiswahili_CD_interaction_model <- glm(produces ~ age * kiswahili_CD_rating + kiswahili_freq_rating + lexical_category + word_length, data = kiswahili_instrument_data, family = "binomial")
...
korean_CD_model <- glm(produces ~ age + korean_CD_rating + korean_freq_rating + lexical_category, data = korean_instrument_data, family = "binomial")
...
korean_CD_summary <- summary(korean_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "korean",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
korean_CD_interaction_model <- glm(produces ~ age * korean_CD_rating + korean_freq_rating + lexical_category, data = korean_instrument_data, family = "binomial")
...
latvian_CD_model <- glm(produces ~ age + latvian_CD_rating + latvian_freq_rating + lexical_category + word_length, data = latvian_instrument_data, family = "binomial")
...
latvian_CD_summary <- summary(latvian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "latvian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
latvian_CD_interaction_model <- glm(produces ~ age * latvian_CD_rating + latvian_freq_rating + lexical_category + word_length, data = latvian_instrument_data, family = "binomial")
...
norwegian_CD_model <- glm(produces ~ age + norwegian_CD_rating + norwegian_freq_rating + lexical_category + word_length, data = norwegian_instrument_data, family = "binomial")
...
norwegian_CD_summary <- summary(norwegian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "norwegian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
norwegian_CD_interaction_model <- glm(produces ~ age * norwegian_CD_rating + norwegian_freq_rating + lexical_category + word_length, data = norwegian_instrument_data, family = "binomial")
...
persian_CD_model <- glm(produces ~ age + persian_CD_rating + persian_freq_rating + lexical_category + word_length, data = persian_instrument_data, family = "binomial")
...
persian_CD_summary <- summary(persian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "persian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
persian_CD_interaction_model <- glm(produces ~ age * persian_CD_rating + persian_freq_rating + lexical_category + word_length, data = persian_instrument_data, family = "binomial")
...
russian_CD_model <- glm(produces ~ age + russian_CD_rating + russian_freq_rating + lexical_category + word_length, data = russian_instrument_data, family = "binomial")
...
russian_CD_summary <- summary(russian_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "russian",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
russian_CD_interaction_model <- glm(produces ~ age * russian_CD_rating + russian_freq_rating + lexical_category + word_length, data = russian_instrument_data, family = "binomial")
...
slovak_CD_model <- glm(produces ~ age + slovak_CD_rating + slovak_freq_rating + lexical_category + word_length, data = slovak_instrument_data, family = "binomial")
...
slovak_CD_summary <- summary(slovak_CD_model)$coefficients %>% as.data.frame() %>%
  ...
  mutate(language = "slovak",
         ...
         standard_error = `Std. Error`,
         p_value = `Pr(>|z|)`)
slovak_CD_interaction_model <- glm(produces ~ age * slovak_CD_rating + slovak_freq_rating + lexical_category + word_length, data = slovak_instrument_data, family = "binomial")
...
spanish_argentinian_CD_model <- glm(produces ~ age + spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_argentinian_instrument_data, family = "binomial")
...
spanish_argentinian_CD_interaction_model <- glm(produces ~ age * spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_argentinian_instrument_data, family = "binomial")
...
spanish_chilean_CD_model <- glm(produces ~ age + spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_chilean_instrument_data, family = "binomial")
...
spanish_chilean_CD_interaction_model <- glm(produces ~ age * spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_chilean_instrument_data, family = "binomial")
...
spanish_european_CD_model <- glm(produces ~ age + spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_european_instrument_data, family = "binomial")
...
spanish_european_CD_interaction_model <- glm(produces ~ age * spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_european_instrument_data, family = "binomial")
...
spanish_mexican_CD_model <- glm(produces ~ age + spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_mexican_instrument_data, family = "binomial")
...
spanish_mexican_CD_interaction_model <- glm(produces ~ age * spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_mexican_instrument_data, family = "binomial")
...
spanish_peruvian_CD_model <- glm(produces ~ age + spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_peruvian_instrument_data, family = "binomial")
...
spanish_peruvian_CD_interaction_model <- glm(produces ~ age * spanish_CD_rating + spanish_freq_rating + lexical_category + word_length, data = spanish_peruvian_instrument_data, family = "binomial")
...
swedish_CD_model <- glm(produces ~ age + swedish_CD_rating + swedish_freq_rating + lexical_category + word_length, data = swedish_instrument_data, family = "binomial")
...
swedish_CD_summary <- summary(swedish_CD_model)$coefficients %>% 
  ...
  mutate(language = "swedish")
swedish_CD_interaction_model <- glm(produces ~ age * swedish_CD_rating + swedish_freq_rating + lexical_category + word_length, data = swedish_instrument_data, family = "binomial")
